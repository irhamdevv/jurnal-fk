...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67c06592211384_67779314',
...
function content_67c06592211384_67779314 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
$_block_repeat=true;
echo $_block_plugin3->smartyFBVFormArea(array('id'=>"submissionStep1"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin4->smartyFBVFormSection(array('list'=>"true",'label'=>"submission.submit.submissionChecklist",'description'=>"submission.submit.submissionChecklistDescription",'id'=>"pkp_submissionChecklist"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php
...
echo $_block_plugin4->smartyFBVFormSection(array('list'=>"true",'label'=>"submission.submit.submissionChecklist",'description'=>"submission.submit.submissionChecklistDescription",'id'=>"pkp_submissionChecklist"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin5->smartyFBVFormSection(array('for'=>"commentsToEditor",'title'=>"submission.submit.coverNote"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin5->smartyFBVFormSection(array('for'=>"commentsToEditor",'title'=>"submission.submit.coverNote"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin6->smartyFBVFormSection(array('label'=>"submission.submit.availableUserGroups",'description'=>"submission.submit.availableUserGroupsDescription",'list'=>true,'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php $_block_repeat=false;
echo $_block_plugin6->smartyFBVFormSection(array('label'=>"submission.submit.availableUserGroups",'description'=>"submission.submit.availableUserGroupsDescription",'list'=>true,'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php } else { ?>
			<?php
...
$_block_repeat=true;
echo $_block_plugin7->smartyFBVFormSection(array('label'=>"submission.submit.contactConsent",'list'=>true,'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin7->smartyFBVFormSection(array('label'=>"submission.submit.contactConsent",'list'=>true,'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin8->smartyFBVFormSection(array('label'=>"submission.submit.availableUserGroups",'list'=>true,'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php $_block_repeat=false;
echo $_block_plugin8->smartyFBVFormSection(array('label'=>"submission.submit.availableUserGroups",'list'=>true,'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('title'=>"submission.submit.copyrightNoticeAgreementLabel"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('title'=>"submission.submit.copyrightNoticeAgreementLabel"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('list'=>"true"));
$_block_repeat=true;
echo $_block_plugin11->smartyFBVFormSection(array('list'=>"true"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin11->smartyFBVFormSection(array('list'=>"true"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
<?php $_block_repeat=false;
echo $_block_plugin3->smartyFBVFormArea(array('id'=>"submissionStep1"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
